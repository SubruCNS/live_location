...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.simple_speech_recognition.SimpleSpeechRecognitionPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin simple_speech_recognition, com.example.simple_speech_recognition.SimpleSpeechRecognitionPlugin", e);
    }
    try {
